...
const TimelineItem = ({ year, title, description, icon: Icon, isLeft }) => (
  <div className={`w-1/2 ${isLeft ? 'pr-8' : 'pl-8'}`}>
    <div className={`p-4 rounded shadow bg-white dark:bg-gray-800 h-full 
                     transition-all duration-300 ease-in-out 
                     hover:shadow-lg hover:scale-[1.03] hover:bg-gray-50 hover:dark:bg-gray-700`}>
        ...
        <main>
          ...
          <section className="mb-12">
            ...
            <div className="flex flex-wrap gap-4">
              {[MySVG, Css, Html, Java, JavaScript, ReactLogo, Tailwind, Git].map((Icon, index) => (
                <span key={index} className="bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-200 p-2 rounded-full transition-transform duration-200 hover:scale-110">
